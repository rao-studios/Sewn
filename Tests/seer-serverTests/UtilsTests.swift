...
final class UtilsTests: XCTestCase {
    ...
    func testModelProviderError() {
        ...
        XCTAssertTrue(error.errorBody.contains("Test error"))
        XCTAssertTrue(error.errorBody.contains("test-model"))
    ...
    func testProcessingError() {
        ...
        XCTAssertTrue(error.errorBody.contains("Processing failed"))
        XCTAssertTrue(error.errorBody.contains("model-123"))
        XCTAssertTrue(error.errorBody.contains("Underlying error"))
