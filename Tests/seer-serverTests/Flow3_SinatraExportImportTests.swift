...
final class Flow3_SinatraExportImportTests: XCTestCase {
    ...
    private let source = SeerRegistry.Owner(id: "export-source-owner")
    private let dest   = SeerRegistry.Owner(id: "export-dest-owner")
    private let other  = SeerRegistry.Owner(id: "export-other-owner")
    ...
    func testExportOwnerIdIsPreservedAsMetadata() throws {
        ...
        let bobOwner = SeerRegistry.Owner(id: "bob-owner")
