...
//  seer-serverTests
//
//  Tests for the RegistryWAL (billing-only, post-Totem overhaul):
//
//    Binary round-trip
...
final class Flow4_RegistryWALTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        tempDir = FileManager.default.temporaryDirectory
            .appendingPathComponent("seer-flow15-\(UUID().uuidString)")
    ...
    /// A WAL file produced before the Totem overhaul may contain retired type codes
    ...
    func testReplay_performanceAccumulated_isAdditive() throws {
        ...
        let first = Seer.DocumentStats(id: "doc-add", retrievalCount: 4, sentimentSum: 2.0)
        RegistryWALRecord.performanceAccumulated([.init(from: first)]).apply(to: &registry)

        let second = Seer.DocumentStats(id: "doc-add", retrievalCount: 3, sentimentSum: 1.5)
    ...
    func testReplay_earningsThenPerformance_sequence() throws {
        ...
        let stats = Seer.DocumentStats(id: "doc-seq", retrievalCount: 4, sentimentSum: 2.8)
        RegistryWALRecord.performanceAccumulated([.init(from: stats)]).apply(to: &registry)
    ...
    func testAppendAndReplayViaNewWALObject() throws {
        ...
        do {
            ...
            let stats = Seer.DocumentStats(id: "doc-int", retrievalCount: 3, sentimentSum: 2.1)
