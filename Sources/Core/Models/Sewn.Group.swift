...
/// A Sewn group object that stores a list of documents relative
...
extension Sewn {
    struct Group: Codable {
        ...
        init(id: String,
             ...
             access: SewnRegistry.Access? = nil,
        ...
        init(from decoder: Decoder) throws {
            ...
            documents    = try c.decodeIfPresent([Sewn.Document].self, forKey: .documents) ?? []
            access       = try c.decodeIfPresent(SewnRegistry.Access.self, forKey: .access)
